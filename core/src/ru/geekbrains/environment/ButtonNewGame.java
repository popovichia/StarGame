...
public class ButtonNewGame extends ScaledButton {
    ...
    private ScreenGameLevel1 screenGameLevel1;
    private boolean isGrow;

    private float animateTimer;

    public ButtonNewGame(TextureAtlas atlas, ScreenGameLevel1 screenGameLevel1) throws GameException {
        super(atlas.findRegion("button_new_game"));
        this.screenGameLevel1 = screenGameLevel1;
        this.isGrow = true;
    }
